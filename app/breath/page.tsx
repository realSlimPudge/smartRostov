...
import { ChevronLeft, GlassWater, Leaf, Shrub, Wind } from "lucide-react";
                        ...
                        <div className="space-y-4 text-gray-700">
                            <div className="flex items-start">
                                ...
                                <p>
                                    ...
                                    Обилие парков и скверов, включая Парк им.
                                    Вити Черевичкина и Ботанический сад ЮФУ
                                </p>
                            </div>
                            ...
                            <div className="flex items-start">
                                ...
                                <p>
                                    ...
                                    Близость к Дону обеспечивает естественную
                                    вентиляцию и очистку воздуха
                                </p>
                            </div>

                            <p className="py-2 pl-4 italic bg-green-50 border-l-4 border-green-500">
                                Нахичевань сохранил свою историческую планировку
                                с широкими улицами и обилием зеленых насаждений,
                                что создает уникальный микроклимат в центре
                                миллионного города
                            </p>
                        </div>
                    </div>
                ...
                <div className="p-8 mx-4 mt-10 w-full max-w-6xl bg-white rounded-2xl shadow-lg">
                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                        <div className="p-5 bg-green-50 rounded-xl border border-green-100">
                            ...
                            <p>
                                Более 35% территории района занимают парки,
                                скверы и защитные зеленые зоны
                            </p>
                        </div>
                        ...
                        <div className="p-5 bg-blue-50 rounded-xl border border-blue-100">
                            ...
                            <p>
                                Широкие улицы и историческая радиальная
                                планировка обеспечивают хорошую вентиляцию
                            </p>
                        </div>
                        ...
                        <div className="p-5 bg-amber-50 rounded-xl border border-amber-100">
                            ...
                            <p>
                                Минимум промышленных предприятий и низкая
                                транспортная нагрузка в жилых зонах
                            </p>
                        </div>
                    </div>
                </div>
