                ...
                <div className="flex gap-x-5 justify-start items-center px-4 pb-10 w-full max-w-6xl">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-blue-700">
                            Экстренные службы, медицинская помощь и советы для
                            ростовчан
                        </p>
                    </div>
                </div>
                                ...
                                <div className="p-5 mt-8 bg-blue-50 rounded-xl border border-blue-200">
                                    ...
                                    <ul className="space-y-2 text-sm">
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                Все звонки на номера 101, 102,
                                                103, 112 бесплатны с любых
                                                телефонов
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                При звонке в экстренные службы
                                                сохраняйте спокойствие и четко
                                                назовите адрес
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                В Ростове работает система
                                                экстренного оповещения МЧС через
                                                СМС
                                            </span>
                                        </li>
                                    </ul>
                                ...
                                <div className="p-5 mt-8 bg-blue-50 rounded-xl border border-blue-200">
                                    ...
                                    <ul className="space-y-2 text-sm">
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                Травмпункты работают
                                                круглосуточно во всех районах
                                                города
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                ...
                                                8863-267-20-20 (единый для всех
                                                поликлиник)
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                ...
                                                доступна через портал Госуслуг
                                            </span>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="p-5 mt-8 bg-blue-50 rounded-xl border border-blue-200">
                                    ...
                                    <ul className="space-y-3 text-sm">
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                Покиньте помещение, вызовите
                                                101, предупредите соседей
                                            </span>
                                        </li>
                                        <li className="flex items-start">
                                            <span className="mr-2 font-bold text-blue-600">
                                        ...
                                        <li className="flex items-start">
                                            ...
                                            <span>
                                                Вызовите 103, сохраните упаковку
                                                от продукта/лекарства
                                            </span>
                                        </li>
                                    </ul>
                                </div>
