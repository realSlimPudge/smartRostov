  ...
  const restaurants = [
    {
      ...
      features: ["Пироги с икрой сазана", "Уха с карпом", "Казачьи песни"],
    ...
    },
    {
      ...
      features: ["Уха со стерлядью", "Фирменный оливье", "Завтраки до 14:00"],
    ...
    },
    {
      ...
      features: ["Воздушные круассаны", "Авторские омлеты", "Сезонная выпечка"],
              ...
              <div className="p-6 text-white bg-gradient-to-r from-amber-500 to-amber-600">
                <div className="flex gap-3 items-start">
                  <div className="p-3 bg-amber-700 rounded-lg">
                    <Utensils className="text-amber-100" size={24} />
                  </div>
                  <div>
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="p-5 rounded-xl bg-amber-600/30 backdrop-blur-sm">
                <h3 className="flex items-center mb-2 text-lg font-bold">
                  <span className="mr-2 text-xl">🍷</span> Напитки
                </h3>
                <p>
                  Попробуйте местные вина из цимлянских виноградников - особенно
                  рекомендуем "Цимлянское чёрное" и "Платовское"
                </p>
              </div>

              <div className="p-5 rounded-xl bg-amber-600/30 backdrop-blur-sm">
                <h3 className="flex items-center mb-2 text-lg font-bold">
                  <span className="mr-2 text-xl">🦞</span> Сезонные деликатесы
                </h3>
                <p>
                  Сезон донских раков длится с апреля по ноябрь - лучшие места
                  для дегустации: "Раки и гады" и "Казачий курень"
                </p>
              </div>

              <div className="p-5 rounded-xl bg-amber-600/30 backdrop-blur-sm">
                <h3 className="flex items-center mb-2 text-lg font-bold">
                  <span className="mr-2 text-xl">🌅</span> Бронирование
                </h3>
                <p>
                  Рекомендуем бронировать столики на верандах заведений заранее
                  - особенно в "ОнегинДаче" и La Fabbrica
                </p>
              </div>

              <div className="p-5 rounded-xl bg-amber-600/30 backdrop-blur-sm">
                <h3 className="flex items-center mb-2 text-lg font-bold">
                  <span className="mr-2 text-xl">🍳</span> Завтраки
                </h3>
                <p>
                  Не пропустите завтраки в "Бистро Гаврош" - их круассаны
                  считаются лучшими на юге России
                </p>
              </div>
            </div>
          </div>
