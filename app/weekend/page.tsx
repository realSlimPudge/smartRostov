...
export default function ConcertsPage() {
    ...
    const concerts = [
        ...
        },
        {
            ...
            features: [
                "Премьера новых песен",
                "Хореографическое шоу",
                "VIP-встречи",
            ],
        },
        {
                            ...
                            <div className="p-5 mt-8 bg-purple-50 rounded-xl border border-purple-200">
                                ...
                                <ul className="space-y-3 text-sm">
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Бронируйте билеты заранее - самые
                                            ожидаемые концерты раскупаются за
                                            2-3 месяца
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                    ...
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Приходите за 1-1.5 часа до начала
                                            для лучших мест
                                        </span>
                                    </li>
                                </ul>
